...
<head>
    ...
    <script>
        function handleSortChange(value) {
            window.location.href = 'ring.jsp?sort=' + value;
        }
    </script>
</head>
<body class="">
    ...
    <div class="text-normal flex justify-between font-semibold pt-20">
        <div>
            ...
            <span id="textForPfMwPh">Rings</span>
            <h1 class="pl-16 font-mono mt-5 text-5xl tracking-tighter">RINGS</h1>
            <p class="pl-16 font-mono text-xl">Elevate your jewelry ensemble with silver and gold rings.</p>
        </div>
                ...
                <div class="ml-6 flex flex-col justify-between">
                    <div>
                        ...
                        <p class="mt-8 text-slate-700">
                            These exquisite rings are crafted with precision and elegance. Made from high-quality materials, they feature a stunning design that adds a touch of sophistication to any outfit. Perfect for special occasions or as a luxurious gift.
                        </p>
                    </div>
